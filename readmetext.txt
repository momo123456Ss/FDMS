...
Pilot Flight document - get original/update version (+) - edit with modify(+) with readonly/modify - get last verison (+) - get document with readonly/modify (+)
Attendant Flight document - get original/update version (+) - edit with modify (+) with readonly/modify - get last verison (+) - get document with readonly/modify (+)
